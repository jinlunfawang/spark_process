...
public class FansFollowerActionSync {
    private static final Logger logger = LoggerFactory.getLogger(FansFollowerActionSync.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("CreativeMaterialSync")
                .config(new SparkConf())
                .enableHiveSupport()
                .getOrCreate();
        String SQL="select mid as redis_key,fids as redis_value from " + inputTable + " where log_date=" + log_date;
    ...
    private static void parseIterator(Iterator<Row> iterator) {
        JedisCluster jc = new JedisCluster(parseHosts(Constants.FANS_FOLLOWER_RELATION_REDIS_ADDRESS));
        ...
        while (iterator.hasNext()) {
            ...
            RedisByteSet redisByteSet = new RedisByteSet(redisKey.getBytes(), redisValue.getBytes(), Constants.FANS_FOLLOWER_RELATION_REDIS_EXPIRE);

...
public class NER2Redis {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SparkSession spark = SparkSession
                ...
                .enableHiveSupport()
                .getOrCreate();
        Dataset<Row> redisDF = spark.sql("select redis_key,concat_ws('&_&', collect_set(redis_value)) as redis_value from " + inputTable + " where log_date=" + log_date +" group by redis_key" );
        redisDF.show(10);
    ...
    private static void parseIterator(Iterator<Row> iterator) {
        JedisCluster jc = new JedisCluster(parseHosts(Constants.DATACENTER_REDIS_ADDR));
        ...
        while (iterator.hasNext()) {
            ...
            RedisByteSet redisByteSet = new RedisByteSet(redisKey.getBytes(), redisValue.getBytes(), Constants.DATACENTER_REDIS_ADDR_EXPIRE);

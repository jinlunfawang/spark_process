...
public class CreativeMaterialSync {
    private static final Logger logger = LoggerFactory.getLogger(CreativeMaterialSync.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SparkSession spark = SparkSession
                ...
                .enableHiveSupport()
                .getOrCreate();
        String SQL="select concat(key_type,'_',key_id) as redis_key,key_fea as redis_value from "+inputTable+" where key_type='creative_type' and concat(log_date,log_hour)="+log_date;

...
public class CleanPidRedis {
    private static final Logger logger = LoggerFactory.getLogger(CleanPidRedis.class);
    ...
    private static void parseIterator(Iterator<Row> iterator) {
        JedisCluster jc = new JedisCluster(parseHosts(Constants.PID_REDIS_ADDRESS));
